...
LIB = '/cluster/tufts/hpc/tools/R/4.2.0'
LIB2 = '/cluster/tufts/dopmanlab/Jacob/packages_r_4.2.0/'
...
setwd("/cluster/tufts/dopmanlabpi/iLAM_Sfrug_202308/")
...
y_top <- 1900 #cage-specific, depending on camera arrangement

#change following values for every experiment
#for ECB, I like 99.9% and 10, I think
out_file_name = "Sfrug_2023" #project-specific
...
# by_change = read_csv("Sfrug_2023_v2.csv")
# 
# by_change = by_change %>% filter(pi != "p10") %>% droplevels() #remove p10 to keep numbering in line
# 
